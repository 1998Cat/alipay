...
public class AlipayDemo {
    ...
    public static void main(String[] args) {
        ...
        /*alipayDemo.test_trade_pay(tradeService);//调用付款*/
        /*alipayDemo.test_trade_query();//查询订单*/
        /*alipayDemo.test_trade_refund();//退款*/
        alipayDemo.test_trade_precreate();//生成预支付订单并生成二维码支付
    ...
    public void test_trade_pay(AlipayTradeService service) {
        ...
        String authCode = "284892866388489237"; // 条码示例，286648048691290423
    ...
    public void test_trade_query() {
        ...
        String outTradeNo = "tradepay15257662622629515858";
    ...
    public void test_trade_precreate() {
        ...
        String subject = "天猫旗舰店品牌xxx门店当面付扫码消费";

        // (必填) 订单总金额，单位为元，不能超过1亿元
        // 如果同时传入了【打折金额】,【不可打折金额】,【订单总金额】三者,则必须满足如下条件:【订单总金额】=【打折金额】+【不可打折金额】
        String totalAmount = "1599.00";
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                dumpResponse(response);
                //保存二维码路径（自己电脑的存放路径）
                String path="C:/Users/You见丶1998/Desktop";
                // 需要修改为运行机器上的路径
